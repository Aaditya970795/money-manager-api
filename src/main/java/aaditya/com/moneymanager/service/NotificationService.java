...
import aaditya.com.moneymanager.repository.ProfileRepository;
    ...
    public void sendDailyIncomeExpenseReminder() {
        ...
        for(ProfileEntity profile : profiles) {
            String body = "Hi " + profile.getFullName() + ",<br><br>"
                    ...
                    + "<a href="+frontendUrl+"style='display':inline-block;padding:10px 20px;background-color:#4CAF50;color:#fff;text-decoration:none;border-radius:5px;font-weight:bold;'>Go to Money Manger</a>"
    ...
    public void sendDailyExpenseSummary() {
        ...
        for (ProfileEntity profile : profiles) {
            ...
            if(!todaysExpenses.isEmpty()) {
                ...
                table.append("<table style='border-collapse:collapse;width:1000%;'>");
